...
<html lang="ja" id="html">
  ...
  <body <?php body_class(); ?> style="visibility: hidden;" onLoad="document.body.style.visibility='visible'" id="body">
        ...
        <div id="container_id" class="container-fluid px-0">          
          <div class="logo-wrap">
           <?php if( is_front_page() ) : ?>         
            <a class="navbar-brand me-0 py-0" href="<?php echo esc_url( home_url() ); ?>"><h1 class="mb-0" id="home"><img src="<?php echo get_template_directory_uri(); ?>/images/common/logo.svg" width="200" height="47.52" alt="<?php bloginfo('name'); ?>"></h1></a>
             <?php else : ?>
          ...
          <div class="menu-black-bg" id="menu-black-bg"></div>
        </div><!-- //container -->
      </nav>
