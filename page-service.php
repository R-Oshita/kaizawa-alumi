...
<section class="division-sec sec">
  <div class="container">
    <div class="ttl-pattern_2-wrap text-center">
      <div class="subttl josefin">DIVISION</div>
      <h2 class="ttl-pattern_2">事業部門</h2>
    </div>
...
<section class="products-sec sec">
  <div class="container">
    <div class="ttl-pattern_2-wrap text-center">
      <div class="subttl josefin">PRODUCTS</div>
      <h2 class="ttl-pattern_2">取扱製品</h2>
    </div>
    <table class="products-table">
      <tbody>
        <tr>
          <th class="table-blue">取扱製品</th>
          <th class="table-blue">説明</th>
        </tr>
        <tr>
          <td>浴室折戸</td>
          <td>浴室入口に設置する折戸（ドア）製品の加工・組立・部品付け・包装業務をおこなっています。</td>
        </tr>
        <tr>
          <td>スイング窓</td>
          <td>スイング窓の障子・枠製品の部品付け・包装業務をおこなっています。</td>
        </tr>
        <tr>
          <td>固定網戸</td>
          <td>固定網戸製品の組立・網張業務をおこなっています。</td>
        </tr>
        <tr>
          <td>オペレーターハンドル</td>
          <td>すべり出し窓の開閉時に操作するハンドル部分の組立・検査・包装業務をおこなっています。</td>
        </tr>
        <tr>
          <td>その他</td>
          <td>その他、建材製品関連の部品の製造業務をおこなっています。</td>
        </tr>
        <tr>
          <td>取扱製品名</td>
          <td>取扱製品についての説明テキストが入ります。取扱製品についての説明テキストが入ります。</td>
        </tr>
      </tbody>
    </table>
  </div>
