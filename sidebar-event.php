...
<div class="sidebar-sticky">
	<div class="mb-4">
	  <h3 class="sidebar-ttl">最新イベント</h3>
		<ul class="sidebar-linklist">
	    <?php
	    	$post_type = get_post_type();
	    	$taxonomy_slug = $post_type.'_taxonomy';
				$args = array(
				'post_type' => $post_type,
		      		...
		      		<div class="sidebar-textbox">
	    			    ...
	    			    <div class="post-cat-wrap">
	    			      <?php 
	    			        ...
	    			        $term_array = get_the_terms( $id,  $taxonomy_slug );  //投稿に割り当てられたタクソノミーのターム（カスタム分類の項目）を取得
	...
	<div class="mb-4">
	  <h3 class="sidebar-ttl">カテゴリー</h3>
	    <?php 
			  $parent_terms = get_terms( $taxonomy_slug, array('hide_empty' => false, 'parent' => 0) );
