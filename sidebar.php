...
<div class="mb-4 sidebar-group sidebar-category">
	<h3 class="sidebar-ttl">カテゴリ</h3>
	<?php
	$my_tax = 'category';  //取得したいタクソノミー名
	$parent_terms = get_terms($my_tax, array('hide_empty' => 1, 'parent' => 0));  //第一階層のタームだけ取得
	...
	?>
			<li>
				...
				<?php
				$child_terms = get_terms($my_tax, array('hide_empty' => 1, 'parent' => $pt_id));
...
<div class="mb-4 sidebar-group sidebar-yearly">
