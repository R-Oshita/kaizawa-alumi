        ...
        <div class="row justify-content-center">
          <div class="col-12 col-lg-8 col-xl-9 pe-lg-4 mb-5">
            ...
            <div class="paging paging-simple mt-5 pt-3 align-items-center mb-md-2">
              ...
              <div class="archivelink"><a href="<?php echo esc_url( home_url() ); ?>/news/">一覧へ</a></div>
                    ...
                    <div class="ba-links-inner">
                      ...
                      <div class="ba-links-sentence">
                        ...
                        <div class="post-cat-wrap">
                          <?php 
                            $id         = $previous_post->ID;
                            $term_array = get_the_terms( $id, 'category' );
                            if (!is_array($term_array)) {
                               $term_array = array(array('title'=>''));
                            } else {
                               foreach ( $term_array as $term ) {
            ...
            <div class="text-center">
              <a href="<?php echo esc_url( home_url() ); ?>/news/" class="btn-standard btn-size300 mt-4 mb-0">一覧へ</a>
            </div>
            <!-- ↑↑リッチな前後記事リンク↑↑ -->
          </div>
